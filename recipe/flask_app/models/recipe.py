...
class Recipe:
    def __init__(self, db_data):
        ...
        self.date_made = db_data['created_date']
        self.under_thirty = db_data['under_thirty']
    ...
    def save(cls, form_data):
        query = """
                INSERT INTO recipes (name,description,instructions,created_date,under_thirty,user_id)
                VALUES (%(name)s,%(description)s,%(instructions)s,%(created_date)s,%(under_thirty)s,%(user_id)s);
                """
